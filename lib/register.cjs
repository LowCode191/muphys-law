...
// Lexical token-overlap scorer. Deliberately simple; measured top-1 recall on
// paraphrased queries is its known weakness (see README § Honest numbers).
// If you swap in BM25/embeddings, keep the interface and re-run the eval.
